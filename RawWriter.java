...
public class RawWriter {
	...
	public static void writeRawDist(List<Course> courseList) {
        ...
        for (Course course : courseList) {
        	...
        	cell13.setCellValue((Integer) course.getNumRank(40.0));
        	Cell cell14 = row.createCell(14);
        	cell14.setCellValue((Integer) course.getNumRank(80.0));
        	Cell cell15 = row.createCell(15);
        	cell15.setCellValue((Integer) course.getNumRank(120.0));
        	Cell cell16 = row.createCell(16);
        	cell16.setCellValue((Integer) course.getNumRank(1000000.0));
